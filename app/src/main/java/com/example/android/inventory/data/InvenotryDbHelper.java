...
public class InvenotryDbHelper extends SQLiteOpenHelper {
    ...
    /**
     * Constructs a new instance of {@link InvenotryDbHelper}.
     *
     * @param context of the app
     */
    public InvenotryDbHelper(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_PRODUCT_TABLE =  "CREATE TABLE " + ProductEntry.TABLE_NAME + " ("
                ...
                + InventoryContract.ProductEntry.COLUMN_QUANTITY + " INTEGER NOT NULL DEFAULT 0);";
